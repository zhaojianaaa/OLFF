...
class OxfordIIITPet(VisionDataset):
	...
	def __getitem__(self, idx: int) -> Tuple[Any, Any]:
		...
		return image, target, self._images[idx]
...
class CUB():
    ...
    def __getitem__(self, index):
        if self.is_train:
            ...
            #img = scipy.misc.imread(os.path.join(self.root, 'images', self.train_imgname[index]))
            #img = io.imread(os.path.join(self.root, 'images', self.train_imgname[index]))
            pathi = os.path.join(self.root, 'images', self.train_imgname[index])
            img = io.imread(pathi)
            target, imgname = self.train_label[index], self.train_imgname[index]
            ...
            #img = scipy.misc.imread(os.path.join(self.root, 'images', self.test_imgname[index]))
            #img = io.imread(os.path.join(self.root, 'images', self.test_imgname[index])) 
            pathi = os.path.join(self.root, 'images', self.test_imgname[index])
            img = io.imread(pathi)
            target, imgname = self.test_label[index], self.test_imgname[index]
