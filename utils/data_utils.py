...
from .dataset import CUB, CarsDataset, NABirds, dogs, INat2017, OxfordIIITPet, Aircraft
...
def get_loader(args):
    ...
    if args.dataset == 'CUB_200_2011':
        ...
        test_transform=transforms.Compose([transforms.Resize((600, 600), Image.BILINEAR),
                                    ...
                                    transforms.ToTensor(),
                                    transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        trainset = OxfordIIITPet(args.data_root, True, train_transform)
        testset = OxfordIIITPet(args.data_root, False, test_transform)
        ...
        test_transform=transforms.Compose([transforms.Resize((600, 600), Image.BILINEAR),
                                    ...
                                    transforms.ToTensor(),
                                    transforms.Normalize([0.485, 0.456, 0.406], [0.229, 0.224, 0.225])])
        trainset = Aircraft(args.data_root, True, train_transform)
        testset = Aircraft(args.data_root, False, test_transform)
